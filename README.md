...
- $ django-admin.py startproject --template https://github.com/Ilyes-Hammadi/django-base-template/zipball/master --extension py,md,rst projectname
- $ cd projectname
