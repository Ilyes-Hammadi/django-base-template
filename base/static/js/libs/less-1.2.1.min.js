...
(function (a, b) {
    ...
    function r(a, b, c) {
        var d, e = b.href ? b.href.replace(/\?.*$/, "") : "", f = "less:" + (b.title || q(e));
    ...
    function w(a, b) {
        var c = "less-error-message:" + q(b), e = '<li><label>{line}</label><pre class="{class}">{content}</pre></li>', f = document.createElement("div"), g, h, i = [], j = a.filename || b;
    ...
    typeof environment == "object" && {}.toString.call(environment) === "[object Environment]" ? (typeof a == "undefined" ? d = {} : d = a.less = {}, f = d.tree = {}, d.mode = "rhino") : typeof a == "undefined" ? (d = exports, f = c("./tree"), d.mode = "node") : (typeof a.less == "undefined" && (a.less = {}), d = a.less, f = a.less.tree = {}, d.mode = "browser"), d.Parser = function (b) {
        ...
        function w(a) {
            ...
            if (typeof a == "string")b = g.charAt(h) === a ? a : null, d = 1, v(); else {
                v();
        ...
        function y(a, b) {
            throw{index: h, type: b || "Syntax", message: a}
        }
        ...
        function C(a, b) {
            var c = A(a, b), d = B(a.index, c), e = d.line, f = d.column, g = c.split("\n");
        ...
        var g, h, i, j, k, l, m, n, o, q = this, r = function () {
        }, s = this.imports = {
            paths: b && b.paths || [],
            queue: [],
            files: {},
        ...
        return this.env = b = b || {}, this.optimization = "optimization" in this.env ? this.env.optimization : 1, this.env.filename = this.env.filename || null, o = {
            imports: s,
            parse: function (a, e) {
                var j, k, p, q, s, t, u = [], v, x = null;
                h = i = n = l = 0, m = [], g = a.replace(/\r\n/g, "\n"), m = function (a) {
                    var c = 0, d = /[^"'`\{\}\/\(\)]+/g, e = /\/\*(?:[^*]|\*+[^\/*])*\*+\/|\/\/.*/g, f = 0, h, i = a[0], j, k;
                    for (var l = 0, m, n; l < g.length; l++) {
                        ...
                        if (m === "{" && !k && !j)f++, i.push(m); else if (m === "}" && !k && !j)f--, i.push(m), a[++c] = i = []; else if (m === "(" && !k && !j)i.push(m), j = !0; else if (m === ")" && !k && j)i.push(m), j = !1; else {
                            if (m === '"' || m === "'" || m === "`")k ? k = k === m ? !1 : k : k = m;
                            i.push(m)
                        }
                    }
                    if (f > 0)throw{type: "Syntax", message: "Missing closing `}`", filename: b.filename};
                ...
                j.toCSS = function (a) {
                    ...
                    return function (e, g) {
                        ...
                        try {
                            var j = a.call(this, {frames: h}).toCSS([], {compress: e.compress || !1})
                        } catch (k) {
                            throw new C(k, b)
                        }
            ...
            parsers: {
                primary: function () {
                    ...
                    call: function () {
                        var a = [], c, d, e, i = h, j = g.charAt(h), k = !1;
                        if (j !== "." && j !== "#")return;
                        ...
                        if (c = w(/^([#.](?:[\w-]|\\(?:[a-fA-F0-9]{1,6} ?|[^a-fA-F0-9]))+)\s*\(/)) {
                            ...
                            while (e = w(this.entities.variable) || w(this.entities.literal) || w(this.entities.keyword)) {
                                e instanceof f.Variable ? w(":") ? (i = x(this.expression, "expected expression"), b.push({
                                    name: e.name,
                                    value: i
                                })) : b.push({name: e.name}) : b.push({value: e});
                                if (!w(","))break
                            }
                    ...
                    var a = [];
                    do if (e = w(this.entities.keyword))a.push(e); else if (w("(")) {
                        p = w(this.property), e = w(this.entity);
                        if (!w(")"))return null;
                        if (p && e)a.push(new f.Paren(new f.Rule(p, e, null, h, !0))); else {
                            if (!e)return null;
                    ...
                    } else if (a = w(/^@[-a-z]+/))if (a === "@font-face") {
                    ...
                    if (w(","))while (g = w(this.expression)) {
                        a.push(g);
                        if (!w(","))break
                    }
    ...
    (function (a) {
            ...
            var b = this.lvalue.eval(a), c = this.rvalue.eval(a), d = this.index, e, e = function (a) {
                switch (a) {
                    ...
                    case"or":
                        return b || c;
                    default:
                        if (b.compare)e = b.compare(c); else {
                            if (!c.compare)throw{type: "Type", message: "Unable to perform comparison", index: d};
                            e = c.compare(b)
                        }
                        switch (e) {
                            case-1:
        ...
        a.mixin = {}, a.mixin.Call = function (b, c, d, e, f) {
            ...
            toCSS: function () {
                ...
                for (var e = 0, f; e < this.params.length; e++)if (this.params[e].name) {
                ...
                var e = this.evalParams(b, c), f, g = [], h;
        ...
        a.Ruleset = function (a, b) {
            ...
            eval: function (b) {
                ...
                if (d.root || d.allowImports)for (var e = 0; e < d.rules.length; e++)d.rules[e] instanceof a.Import && Array.prototype.splice.apply(d.rules, [e, 1].concat(d.rules[e].eval(b)));
